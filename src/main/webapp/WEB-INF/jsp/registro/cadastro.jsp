...
<title>Sistema de Gestão de Registros</title>
	...
	<div class="container">	
		<form action="/registro/incluir" method="post">	
			<div class="form-group">
		      ...
		      <input value="Meu Registro" type="text" class="form-control" placeholder="Entre com a descrição do registro" name="descricao">
		    </div>			
			...
			<c:if test="${empty categorias}">
		      <label>Não existem categorias cadastradas!!!</label>	
